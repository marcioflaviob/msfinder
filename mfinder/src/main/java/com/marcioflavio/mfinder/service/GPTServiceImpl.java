...
public class GPTServiceImpl implements GPTService{
    ...
    private String systemMessage = "You will work as a movie curator in the language English. Recommend me a movie based on the lyrics and mood of a song informed by the user." +
    "You should also inform 3 points justifying why this movie is similar to the song, the last point has to be related to the rhythm of the song and the vibe and mood of the movie, keep each point with 150 characters max and remember not to spoil the movie plot." + 
    ...
    "3. Rhythm and Vibe Connection: The movie's soundtrack has a heartfelt, acoustic quality that mirrors the emotional depth of the song. The rhythm of the music, coupled with the film's narrative, creates a resonant and uplifting atmosphere that aligns with the mood of 'Happy Home'. IMPORTANT: You HAVE TO reply in the language: English. The original language of the movie doesn't need to be in this language.";
